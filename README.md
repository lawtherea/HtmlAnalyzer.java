# Teste Técnico — Software Development Intern (HTML Analyzer)

## Objetivo

Criar um programa em Java que, a partir de uma URL, leia o conteúdo HTML (linha a linha) e retorne o trecho de texto que estiver no nível mais profundo da estrutura. Se houver mais de um trecho no nível máximo, retorna o primeiro. Por exemplo:
